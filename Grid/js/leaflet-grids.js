 ...
 */
var coordinates = [[40.987914, 28.919453], [40.991924, 28.919472], [40.995683, 28.920772], [40.999628, 28.91982], [41.00981, 28.921857], [41.013572, 28.921402], [41.019641, 28.924149], [41.019458, 28.921813], [41.024844, 28.928906], [41.024339, 28.929616], [41.029328, 28.934922], [41.031309, 28.936135], [41.033308, 28.940039], [41.034508, 28.940287], [41.034913, 28.939131], [41.037764, 28.939291], [41.039812, 28.942122], [41.039483, 28.943373], [41.040774, 28.944535], [41.036489, 28.947258], [41.035256, 28.949188], [41.03158, 28.950464], [41.030976, 28.952435], [41.029315, 28.952998], [41.02833, 28.957487], [41.024034, 28.960947], [41.022859, 28.963099], [41.021251, 28.963838], [41.020424, 28.965947], [41.019493, 28.966241], [41.019612, 28.969517], [41.018301, 28.971334], [41.016838, 28.976818], [41.016679, 28.981768], [41.017542, 28.9839], [41.017447, 28.9865], [41.012424, 28.988072], [41.010179, 28.987798], [41.006232, 28.98595], [41.002635, 28.98147], [41.001751, 28.977768], [41.001238, 28.978419], [41.002061, 28.960872], [41.00119, 28.961683], [41.00099, 28.965085], [41.000925, 28.962551], [41.001846, 28.958516], [41.001284, 28.958294], [41.001873, 28.958403], [41.002058, 28.957297], [41.001425, 28.956194], [41.002373, 28.955468], [41.002197, 28.954111], [41.001624, 28.954247], [41.002185, 28.95402], [41.001466, 28.952502], [40.998855, 28.953997], [40.998427, 28.961031], [40.998656, 28.953774], [40.996688, 28.950068], [40.996187, 28.945225], [40.996911, 28.941808], [40.998804, 28.938637], [41.000664, 28.937845], [41.001753, 28.938693], [40.999997, 28.935135], [40.994926, 28.931977], [40.991774, 28.927855], [40.99105, 28.929318], [40.99276, 28.929843], [40.992289, 28.930244], [40.990905, 28.929411], [40.9914, 28.927922], [40.987837, 28.923884], [40.987914, 28.919453]];
var ilce = L.polygon(coordinates, { "color": "blue" });
var koseler = ilce.getBounds();
var polylines=[];
L.Grids.Distance = L.Grids.extend({

    _gridSpacing: function () {
        var zoom = this._map.getZoom();
        var lat = ilce.getBounds().getCenter().lat;
        if (Math.abs(lat) > 55) {
            zoom += 1;
        }
        if (zoom > 18) {
    ...
    _gridLines: function () {
        ...
        var metersAtLat = metersPerPixel(ilce.getBounds().getCenter().lat, zoom);
        var gridSize = this._gridSize * metersAtEquator / metersAtLat;

        var latCoord = LLtoSM(ilce.getBounds().getCenter()).y;
        var latCoordUp = latCoord;
        var latCoordDown = latCoord;


        //var northwest = [koseler._northEast.lat, koseler._southWest.lng];
        //var souteast = [koseler._southWest.lat, koseler._northEast.lng];
        //var northeast = [koseler._northEast.lat, koseler._northEast.lng];
        //var soutwest = [koseler._southWest.lat, koseler._southWest.lng]

        var southeast = { "lat": koseler._southWest.lat, "lng": koseler._northEast.lng };
        var southwest = { "lat": koseler._southWest.lat, "lng": koseler._southWest.lng };
        var northwest = {"lat": koseler._northEast.lat,"lng": koseler._southWest.lng };

        var eastBound = LLtoSM(southeast).x;
        var westBound = LLtoSM(southwest).x;
        var northBound = LLtoSM(northwest).y;
        var southBound = LLtoSM(southwest).y;
        ...
        //var eastBound = 3395117.239439857;
        //var westBound = 3391452.3675900004;
        //var northBound = 4828533.083762456;
        //var southBound = 4826762.683428736;

        // draw center horizontal line
        var leftPointCenter = SMtoLL(L.point(westBound, latCoord));
        var rightPointCenter = SMtoLL(L.point(eastBound, latCoord));
        lines.push(L.polyline([leftPointCenter, rightPointCenter], this.options.lineStyle).bindPopup("asd"));
        ...
        while (latCoordUp < northBound) {
            ...
            for (var i = 0; i < 2; i++) {
                ...
                lines.push(L.polyline([leftPoint, rightPoint], this.options.lineStyle).bindPopup("asd"));
            }
        }
        // draw center vertical line
        var lngCoord = LLtoSM(ilce.getBounds().getCenter()).x;
        ...
        lines.push(L.polyline([topPointCenter, bottomPointCenter], this.options.lineStyle).bindPopup("asd"));
        ...
        while (lngCoordRight < eastBound) {
            ...
            for (var i = 0; i < 2; i++) {
                ...
                lines.push(L.polyline([topPoint, bottomPoint], this.options.lineStyle).bindPopup("asd"));
            }
        }
        for (var i = 0; i < lines.length; i++) {
            polylines[i] = lines[i]._latlngs;
        }
        return lines;
    },
});
